...
export default function Index() {
  ...
  return (
    ...
    >
      {/* styled infinite scroll view container */}
      <View style={styles.infiniteScrollContainer}>
        ...
        <LinearGradient colors={["transparent", "#fff"]} style={styles.linearGradienSpace} />
      </View>
      {/* container */}
      <View style={styles.contentAuthContainer}>
        ...
        <Animated.View style={styles.privacyContainer} entering={FadeInDown.delay(400)}>
          <Text style={styles.privacyText}>
            ...
            to learn about personal data processin at wolt
          </Text>
        </Animated.View>
      </View>
    </View>
